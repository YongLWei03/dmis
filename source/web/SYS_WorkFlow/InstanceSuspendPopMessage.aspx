<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InstanceSuspendPopMessage.aspx.cs" Inherits="SYS_WorkFlow_InstanceSuspendPopMessage" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
        ...
        <table border="0" cellpadding="0" cellspacing="1" style="background-color: #330000; width: 408px; height: 147px;">
            ...
            <tr>
                ...
                <td style="background-color: #ffffff; width: 35%; height: 26px;">
                    <asp:TextBox ID="txtTID" runat="server" Visible="False" Width="27px" meta:resourcekey="txtTIDResource1"></asp:TextBox>
                    <asp:TextBox ID="txtPACKNO" runat="server" Visible="False" Width="20px" meta:resourcekey="txtPACKNOResource1"></asp:TextBox><asp:TextBox
                        ID="txtF_PACKTYPENAME" runat="server" Visible="False" Width="20px" meta:resourcekey="txtF_PACKTYPENAMEResource1"></asp:TextBox><asp:TextBox
                            ID="txtF_PACKTYPENO" runat="server" Visible="False" Width="20px" meta:resourcekey="txtF_PACKTYPENOResource1"></asp:TextBox></td>
            </tr>
            <tr>
