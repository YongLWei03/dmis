<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InstanceOvertimeDisposeQuery.aspx.cs" Inherits="SYS_WorkFlow_InstanceOvertimeDisposeQuery" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>业务处理超时查询</title>
</head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 1000px">
            ...
            <tr>
                <td style="width: 100px; height: 39px" valign="middle">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 698px">
                        <tr>
                            <td style="font-size: 11px; width: 68px; height: 30px; text-align: center">
                                业务类别</td>
                            ...
                            <td style="width: 69px; height: 30px; text-align: center">
                        ...
                        <tr>
                            <td style="width: 68px; height: 31px; text-align: center; font-size: 11px;">
                                开始日期</td>
                            <td style="width: 100px; height: 31px;">
                                <cc1:WebDate ID="wdlStart" runat="server" DateTimeStyle="Date" />
                            </td>
                            <td style="width: 73px; height: 31px; text-align: center; font-size: 9pt;">
                                终止日期</td>
                            <td style="width: 100px; height: 31px; text-align: center;">
                                <cc1:WebDate ID="wdlEnd" runat="server" DateTimeStyle="Date" />
                            </td>
                            <td style="width: 92px; height: 31px; text-align: center; font-size: 9pt;">
                                任务状态</td>
                            <td style="width: 90px; height: 31px; text-align: center">
                                <asp:DropDownList ID="ddlStatus" runat="server" Width="77px">
                ...
                <td style="height: 299px" align="center" valign="top">
                    <asp:GridView ID="grvList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="f_finishdate" HeaderText="实际完成时间">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="标准完成时间" DataField="f_last_finished_time">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="f_planday" HeaderText="标准小时数">
                                <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="f_workday" HeaderText="实耗小时数">
                                <ItemStyle Width="70px" />
                            </asp:BoundField>
