...
public partial class YW_DD_frmDD_ACCIDENT_ANALYSIS : PageBaseList
{
    string _sql;
    ...
    protected override void btnModify_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../SYS_Common/frmBrowseDetail.aspx?TID=" + grvList.SelectedDataKey[0].ToString() + "&URL=" + Session["Url"].ToString() + "&FuncId=" + Session["FuncId"].ToString());
    }
