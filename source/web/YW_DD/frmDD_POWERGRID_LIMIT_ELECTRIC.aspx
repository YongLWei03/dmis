<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDD_POWERGRID_LIMIT_ELECTRIC.aspx.cs" Inherits="YW_DD_frmDD_POWERGRID_LIMIT_ELECTRIC" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" EnableEventValidation="false" %>
    ...
    <div id="list_data">
        <asp:GridView id="grvList" runat="server" meta:resourcekey="grvListResource1" Width="100%" PageSize="20" OnSelectedIndexChanged="grvRef_SelectedIndexChanged" DataKeyNames="TID" CssClass="font" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="无数据！">
            <Columns>
                ...
                <asp:BoundField DataField="LINE_NO" HeaderText="线路名称" meta:resourcekey="BoundFieldResource2" >
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="LOADS" HeaderText="负荷" meta:resourcekey="BoundFieldResource6">
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="REASON" HeaderText="限电原因" meta:resourcekey="BoundFieldResource5" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                
                <asp:BoundField DataField="STARTTIME" HeaderText="停电时间" DataFormatString="{0:dd-MM-yyyy HH:mm}" HtmlEncode="False" meta:resourcekey="BoundFieldResource3" >
                    <ItemStyle Width="80px" HorizontalAlign="Center"  />
                </asp:BoundField>
                <asp:BoundField DataField="STARTER" HeaderText="停电发令人" meta:resourcekey="BoundFieldResource10">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="ENDTIME" DataFormatString="{0:dd-MM-yyyy HH:mm}" HeaderText="送电时间"
                    HtmlEncode="False" meta:resourcekey="BoundFieldResource4" >
                    <ItemStyle Width="80px" HorizontalAlign="Center"  />
                </asp:BoundField>
                <asp:BoundField DataField="RESTORE_STARTER" HeaderText="送电发令人" meta:resourcekey="BoundFieldResource7">
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="STOP_HOURS" HeaderText="停电小时数" DataFormatString="{0:N2}" HtmlEncode="False"  meta:resourcekey="BoundFieldResource8">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="LOSSES" HeaderText="损失电量" DataFormatString="{0:N2}" HtmlEncode="False"  meta:resourcekey="BoundFieldResource9">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
            </Columns>
