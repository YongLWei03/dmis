<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDD_DISPATCH_COMMAND_FORM.aspx.cs" Inherits="YW_DD_frmDD_DISPATCH_COMMAND_FORM" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" EnableEventValidation="false" %>
    ...
    <div id="list_control">
        <table class="invisible_table">
            <tr>
                ...
                <td class="invisible_cell">
                    <asp:Button ID="btnSaveExcel" runat="server" Enabled="False" OnClick="btnSaveExcel_Click" Text="Excel" meta:resourcekey="btnSaveExcelResource1" /></td>
            </tr>
        </table>
    </div>
    <div id="list_data">
          <asp:GridView ID="grvList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="NUM" HeaderText="编号" meta:resourcekey="BoundFieldResource1" >
                        <ItemStyle Width="60px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="STARTER" HeaderText="发令人" meta:resourcekey="BoundFieldResource2" >
                        <ItemStyle Width="60px" />
                    </asp:BoundField>
                    
                    <asp:BoundField DataField="START_TIME" HeaderText="发令时间" DataFormatString="{0:dd-MM-yyyy HH:mm}" HtmlEncode="False" meta:resourcekey="BoundFieldResource3" >
                        <ItemStyle Width="80px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="ACCEPT_UNIT" HeaderText="受令单位" meta:resourcekey="BoundFieldResource8">
                        <ItemStyle Width="80px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="ACCEPTER" HeaderText="受令人" meta:resourcekey="BoundFieldResource6">
                        <ItemStyle Width="60px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="COMMAND_CONTENT" HeaderText="调度命令内容" meta:resourcekey="BoundFieldResource5" >
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:BoundField DataField="REPLY_TIME" DataFormatString="{0:dd-MM-yyyy HH:mm}" HeaderText="回令时间"
                        HtmlEncode="False" meta:resourcekey="BoundFieldResource4" >
                        <ItemStyle Width="80px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="CHECKER" HeaderText="审核人" meta:resourcekey="BoundFieldResource7">
                        <ItemStyle Width="60px" />
                    </asp:BoundField>
                </Columns>
