<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmZDH_COMPU_ROOM_PATROL_LIST_Det.aspx.cs" Inherits="YW_ZDH_frmZDH_COMPU_ROOM_PATROL_LIST_Det" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>自动化机房设备巡视记录</title>
</head>
    ...
    <div >
        <table class="invisible_table">
            <tr>
                ...
                <asp:Label ID="Label1" runat="server" Text="巡视日期" meta:resourcekey="Label1Resource1"></asp:Label></td>
                <td style="width: 100px; height: 21px;">
                    <cc1:WebDate ID="wdlDate" runat="server" DateStyle="DateFormat3" DateTimeStyle="Date"
                        myDateWidth="80px" ButtonText=".." meta:resourcekey="wdlDateResource1" />
                </td>
                <td style="width: 100px; height: 21px;">
