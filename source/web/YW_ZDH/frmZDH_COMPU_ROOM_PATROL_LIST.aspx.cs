...
public partial class YW_ZDH_frmZDH_COMPU_ROOM_PATROL_LIST : PageBaseList
{
    private string _sql;
    ...
    protected override void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        _sql = "delete from T_ZDH_COMPU_ROOM_PATROL_LIST where to_char(DATEM,'YYYYMMDD')='" + Convert.ToDateTime(grvList.SelectedDataKey.Value).ToString("yyyyMMdd") + "'";
    ...
    protected override void  btnModify_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("frmZDH_COMPU_ROOM_PATROL_LIST_Det.aspx?date=" + grvList.SelectedDataKey[0].ToString() + "&URL=" + Session["URL"].ToString() );
    }
}
