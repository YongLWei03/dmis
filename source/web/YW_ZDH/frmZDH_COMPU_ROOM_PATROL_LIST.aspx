<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmZDH_COMPU_ROOM_PATROL_LIST.aspx.cs" Inherits="YW_ZDH_frmZDH_COMPU_ROOM_PATROL_LIST" Culture="auto" meta:resourcekey="PageResource2" UICulture="auto" %>
    ...
    <div id="list_data">
        <asp:GridView ID="grvList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DATEM" DataFormatString="{0:yyyy-MM-dd}" HeaderText="巡视日期"
                    HtmlEncode="False" meta:resourcekey="BoundFieldResource1" >
                </asp:BoundField>
                <asp:BoundField DataField="INSPECTOR" HeaderText="巡视人" meta:resourcekey="BoundFieldResource2" >
                </asp:BoundField>
            </Columns>
        </asp:GridView>
    </div>
