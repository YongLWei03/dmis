...
public partial class YW_TX_frmTX_RUNNING_LOG : PageBaseList
{
    private string _sql;
    ...
    protected override void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        _sql = "delete from T_TX_RUNNING_LOG where to_char(DATEM,'YYYYMMDD')='" + Convert.ToDateTime(grvList.SelectedDataKey.Value).ToString("yyyyMMdd") + "'";
    ...
    protected override void btnModify_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("frmTX_RUNNING_LOG_Det.aspx?date=" + grvList.SelectedDataKey[0].ToString() + "&URL=" + Session["URL"].ToString());
    }
}
