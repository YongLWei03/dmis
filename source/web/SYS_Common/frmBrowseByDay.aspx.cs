...
public partial class SYS_Common_frmBrowseByDay : PageBaseList
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                JScript.Alert(GetGlobalResourceObject("WebGlobalResource", "ComBrowseByDay001").ToString());   //要翻译
                return;
            }
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        {
            LoadHeader();
            ViewState["BaseQuery"] = "to_char(" + Session["DateQueryCol"].ToString() + ",'YYYYMMDD')='" + wdlDay.getTime().ToString("yyyyMMdd") + "'";
