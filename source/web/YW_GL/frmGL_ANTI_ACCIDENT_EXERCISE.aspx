<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmGL_ANTI_ACCIDENT_EXERCISE.aspx.cs" Inherits="YW_GL_frmGL_ANTI_ACCIDENT_EXERCISE" Culture="auto" meta:resourcekey="PageResource2" UICulture="auto" EnableEventValidation="false"%>
    ...
    <div id="list_data">
        <asp:GridView id="grvList" runat="server" meta:resourcekey="grvListResource1" Width="100%" PageSize="20" OnSelectedIndexChanged="grvRef_SelectedIndexChanged" DataKeyNames="TID" CssClass="font" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="">
            <Columns>
                ...
                <asp:BoundField DataField="UNIT" HeaderText="单位" meta:resourcekey="BoundFieldResource1" >
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                
                <asp:BoundField DataField="DATEM" HeaderText="演习时间" DataFormatString="{0:yyyy-MM-dd HH:mm}" HtmlEncode="False" meta:resourcekey="BoundFieldResource3" >
                    <ItemStyle Width="80px" HorizontalAlign="Center"  />
                </asp:BoundField>
                <asp:BoundField DataField="LEADER" HeaderText="领导人" meta:resourcekey="BoundFieldResource6">
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="ATTENDEE" HeaderText="参加人员" meta:resourcekey="BoundFieldResource5" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="CONTENT" HeaderText="演习内容" meta:resourcekey="BoundFieldResource2" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="ANALYSIS" HeaderText="分析判断" meta:resourcekey="BoundFieldResource4">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="PROCESSING_METHOD" HeaderText="处理步骤" meta:resourcekey="BoundFieldResource7">
                    <ItemStyle HorizontalAlign="Left"  />
                </asp:BoundField>
                <asp:BoundField DataField="EVALUATION" HeaderText="评价" meta:resourcekey="BoundFieldResource8">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="CHECKER" HeaderText="评价人" meta:resourcekey="BoundFieldResource9">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
            </Columns>
