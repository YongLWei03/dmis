...
public partial class YW_STATION_frmSTATION_RUNNING_LOG_Query : PageBaseList
{
    private string _sql;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            initStation();
            ddlStation.SelectedIndex = ddlStation.Items.IndexOf(ddlStation.Items.FindByValue(Session["DepartID"].ToString()));
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        if (ddlStation.SelectedItem != null && ddlStation.SelectedValue != "0")
            query.Append("STATION_ID=" + ddlStation.SelectedItem.Value + " and ");
        query.Append(" SHIFT_DATE>='" + start.ToString("yyyyMMdd") + "' and SHIFT_DATE<='" + end.ToString("yyyyMMdd") + "'");
