<%@ page language="C#" autoeventwireup="true" inherits="SYS_Common_frmBrowseByYear, App_Web_og9prjkz" culture="auto" uiculture="auto" meta:resourcekey="PageResource2" stylesheettheme="default" %>
        ...
        <table class="invisible_table">
            <tr>
                <td class="invisible_cell">
                    <asp:Label ID="Label1" runat="server" Text="年份" meta:resourcekey="Label1Resource1"></asp:Label></td>
                <td class="invisible_cell">
                    <cc1:HtmlComboBox ID="hcbYear" runat="server" Width="80px" EnableAutoFill="False" IsSupportedBrowser="True" MaxLength="0" meta:resourcekey="hcbYearResource1" Rows="1" SelectedText="">
