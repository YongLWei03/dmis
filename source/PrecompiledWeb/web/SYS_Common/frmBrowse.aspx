<%@ page language="C#" autoeventwireup="true" inherits="SYS_Common_frmBrowse, App_Web_og9prjkz" culture="auto" uiculture="auto" meta:resourcekey="PageResource2" stylesheettheme="default" %>
    ...
    <div id="list_control">
        <table class="invisible_table">
            <tr>
                ...
                <td class="invisible_cell">
                    <asp:Button ID="btnQuery" runat="server" OnClick="btnQuery_Click" Text="检索" meta:resourcekey="btnQueryResource1" Visible="False" /></td>
