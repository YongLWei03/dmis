<%@ page language="C#" autoeventwireup="true" inherits="SYS_Common_frmBrowseByDay, App_Web_og9prjkz" culture="auto" uiculture="auto" meta:resourcekey="PageResource2" stylesheettheme="default" %>
        ...
        <table class="invisible_table">
            <tr>
                <td class="invisible_cell">
                    <asp:Label ID="Label1" runat="server" Text="日期" meta:resourcekey="Label1Resource1"></asp:Label></td>
                <td class="invisible_cell">
                    <cc1:WebDate ID="wdlDay" runat="server" ButtonText=".." DateStyle="DateFormat3"
                        DateTimeStyle="Date" meta:resourcekey="wdlStartResource1" myDateWidth="80px" />
                </td>
                <td class="invisible_cell">
