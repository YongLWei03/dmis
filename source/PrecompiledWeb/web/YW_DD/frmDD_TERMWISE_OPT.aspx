<%@ page language="C#" autoeventwireup="true" inherits="YW_DD_frmDD_TERMWISE_OPT, App_Web_docfbltz" culture="auto" uiculture="auto" enableeventvalidation="false" meta:resourcekey="PageResource2" stylesheettheme="default" %>
    ...
    <div id="list_data">
        <asp:GridView id="grvList" runat="server" meta:resourcekey="grvListResource1" Width="100%" PageSize="20" OnSelectedIndexChanged="grvRef_SelectedIndexChanged" DataKeyNames="TID" CssClass="font" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="无数据！">
            <Columns>
                ...
                <asp:BoundField DataField="RUN_TIME" HeaderText="执行时间" DataFormatString="{0:yyyy-MM-dd HH:mm}" HtmlEncode="False" meta:resourcekey="BoundFieldResource3" >
                    <ItemStyle Width="80px" HorizontalAlign="Center"  />
                </asp:BoundField>
                <asp:BoundField DataField="ACCEPTER" HeaderText="受令人" meta:resourcekey="BoundFieldResource6">
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="TASK" HeaderText="操作任务" meta:resourcekey="BoundFieldResource5" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="WRITER" HeaderText="拟票人">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="WRITE_TIME" DataFormatString="{0:yyyy-MM-dd HH:mm}" HeaderText="拟票时间"
                ...
                <asp:BoundField DataField="CHECKER" HeaderText="审查人">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="GUARDIAN" HeaderText="监护人">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
            </Columns>
