<%@ page language="C#" autoeventwireup="true" inherits="YW_DD_frmDD_Shift, App_Web_docfbltz" culture="auto" uiculture="auto" validaterequest="false" meta:resourcekey="PageResource1" stylesheettheme="default" %>
            ...
            <table id="Table1" runat="server" cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr>
                        <td class="SelectedTopBorder" id="Cell1" align="center" style="width: 70px; height: 19px;">
                            <asp:LinkButton ID="lbnView1" runat="server"  OnClick="lbnView1_Click" meta:resourcekey="lbnView1Resource1">值班信息</asp:LinkButton></td>
                        <td class="SepBorder" style="width: 2px; height: 19px;">
                            &nbsp;</td>
                        <td class="TopBorder" id="Cell2" align="center"  style="width: 70px; height: 19px;">
                            <asp:LinkButton ID="lbnView2" runat="server" OnClick="lbnView2_Click" meta:resourcekey="lbnView2Resource1">运行方式</asp:LinkButton></td>
                        <td class="SepBorder" style="width: 2px; height: 19px;">
                            &nbsp;</td>
                        <td class="TopBorder" id="Cell3" align="center"  style="width: 70px; height: 19px;">
                            <asp:LinkButton ID="lbnView3" runat="server" OnClick="lbnView3_Click" meta:resourcekey="lbnView3Resource1">异常情况</asp:LinkButton></td>
                        <td class="SepBorder" style="width: 2px; height: 19px;">
                            &nbsp;</td>
                        <td class="TopBorder" id="Cell4" align="center"  style="width: 70px; height: 19px;">
                            <asp:LinkButton ID="lbnView4" runat="server" OnClick="lbnView4_Click" meta:resourcekey="lbnView4Resource1">其他情况</asp:LinkButton></td>
                    ...
                    <td colspan="8" style="border-left: gray 1px solid;border-right: gray 1px solid;border-bottom: Gray 1px solid">
                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                            ...
                            <table class="slim_table" style="width:90%;">
                                        <tr >
                                            <td class="slim_table_td_desc" style="height: 40px" >
                                                <asp:Label ID="lblDATEM" runat="server" Text="日期" meta:resourcekey="lblDATEMResource1"></asp:Label></td>
                                            <td class="slim_table_td_control" style="height: 40px">
                                            ...
                                            <td class="slim_table_td_desc" style="height: 40px; width: 94px;" >
                                        ...
                                        <tr>
                                            <td colspan="4" style="height: 44px" >
                                                ...
                                                <strong>
                                                    <asp:Label ID="Label1" runat="server" Text="当    班" Width="104px" meta:resourcekey="Label1Resource1" Height="15px" Font-Overline="False" Font-Size="12pt"></asp:Label></strong></span></td>
                                        </tr>
                                        <tr>
                                            <td class="slim_table_td_desc" style="height: 40px">
                                        ...
                                        <tr style="font-size: 12pt; height: 40px">
                                            <td class="slim_table_td_desc" style="height: 40px" >
                                                <asp:Label ID="lblNEXT_SHIFT_MAN1" runat="server" Text="正值调度员" meta:resourcekey="lblNEXT_SHIFT_MAN1Resource1" Font-Size="9pt"></asp:Label></td>
                                            <td class="slim_table_td_control" style="height: 40px">
                                            ...
                                            <td class="slim_table_td_control" style="height: 40px"><asp:DropDownList ID="ddlNEXT_SHIFT_MAN2" runat="server" Width="109px" meta:resourcekey="ddlNEXT_SHIFT_MAN2Resource1">
                                            </asp:DropDownList></td>
                                        </tr>
                                        <tr >
                                            <td class="slim_table_td_desc" style="height: 40px">
