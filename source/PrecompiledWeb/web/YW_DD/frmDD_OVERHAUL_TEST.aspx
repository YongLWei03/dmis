<%@ page language="C#" autoeventwireup="true" inherits="YW_DD_frmDD_OVERHAUL_TEST, App_Web_docfbltz" culture="auto" uiculture="auto" enableeventvalidation="false" meta:resourcekey="PageResource1" stylesheettheme="default" %>
    ...
    <div id="list_data">
        <asp:GridView ID="grvList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SWITCH_LINE_NUMBER" HeaderText="开关线路编号" meta:resourcekey="BoundFieldResource2">
                        <ItemStyle Width="80px" />
                    </asp:BoundField>
                    
                    <asp:BoundField DataField="POWER_CUT_TIME" HeaderText="停电时间" DataFormatString="{0:dd-MM-yyyy HH:mm}" HtmlEncode="False" meta:resourcekey="BoundFieldResource3" >
                        <ItemStyle Width="80px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="POWER_RESTORE_TIME" DataFormatString="{0:dd-MM-yyyy HH:mm}" HeaderText="送电时间"
                        HtmlEncode="False" meta:resourcekey="BoundFieldResource4" >
                        <ItemStyle Width="80px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="CONTENT" HeaderText="工作内容" meta:resourcekey="BoundFieldResource5" >
                    ...
                    <asp:BoundField DataField="REASON" HeaderText="原因" meta:resourcekey="BoundFieldResource8" >
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                </Columns>
