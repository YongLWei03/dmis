<%@ page language="C#" autoeventwireup="true" inherits="SYS_WorkFlow_InstanceAbolish, App_Web_iakvuhia" culture="auto" uiculture="auto" meta:resourcekey="PageResource2" stylesheettheme="default" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 1200px">
            <tr>
                <td style="background-image: url(../img/main_bar.jpg); background-color: #006699; height: 20px; font-size: 10pt; text-align: left;" valign="middle">
                    ...
                    <asp:Label ID="lblFuncName" runat="server" Text="业务作废" meta:resourcekey="lblFuncNameResource1"></asp:Label></td>
            </tr>
            <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 100px; height: 31px">
                                <asp:DropDownList ID="ddlPackStatus" runat="server" Width="70px" meta:resourcekey="ddlPackStatusResource1">
                                    ...
                                    <asp:ListItem meta:resourcekey="ListItemResource2">作废</asp:ListItem>
                                </asp:DropDownList></td>
                        </tr>
                    </table>
                </td>
                ...
                <td style="height: 299px" align="center" valign="top">
                    <asp:GridView ID="grvList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:ButtonField CommandName="Abolish" HeaderText="作废" Text="作废" meta:resourcekey="ButtonFieldResource3">
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="35px" />
                            </asp:ButtonField>
                            ...
                            <asp:BoundField HeaderText="接单时间" DataField="f_receivedate" meta:resourcekey="BoundFieldResource9">
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
                        </Columns>
