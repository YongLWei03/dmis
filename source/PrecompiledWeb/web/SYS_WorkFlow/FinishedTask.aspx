<%@ page language="C#" autoeventwireup="true" inherits="SYS_WorkFlow_FinishedTask, App_Web_iakvuhia" enableeventvalidation="false" culture="auto" uiculture="auto" meta:resourcekey="PageResource2" stylesheettheme="default" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 1160px">
            <tr>
                <td style="background-image: url(../img/main_bar.jpg); background-color: #006699; height: 20px; font-size: 9pt; text-align: left;" valign="middle">
                    ...
                    <asp:Label ID="lblFuncName" runat="server" Text="已归档的任务" meta:resourcekey="lblFuncNameResource1"></asp:Label></td>
            </tr>
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 672px; height: 50px;
                        ...
                        <tr>
                            <td style="font-size: 9pt; width: 164px; height: 27px; text-align: center">
                                <asp:Label ID="Label3" runat="server" Text="变电站" Width="36px" meta:resourcekey="Label3Resource1"></asp:Label></td>
            ...
            <tr>
                <td style="height: 299px" align="center" valign="top">
                    <asp:GridView ID="grvList" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CellPadding="4" Font-Size="9pt" ForeColor="#333333" PageSize="15" Width="1160px" OnRowCommand="grvList_RowCommand" DataKeyNames="F_NO,F_PACKTYPENO" EmptyDataText="无数据！" OnRowDataBound="grvList_RowDataBound" AllowSorting="True" OnSorting="grvList_Sorting" meta:resourcekey="grvListResource1">
                        <Columns>
                            ...
                            <asp:BoundField DataField="f_createdate" HeaderText="创建时间" SortExpression="f_createdate" meta:resourcekey="BoundFieldResource5">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="f_archivedate" HeaderText="结案时间" SortExpression="f_archivedate" meta:resourcekey="BoundFieldResource6">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="实际用时" meta:resourcekey="BoundFieldResource7">
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="PLAN_STARTTIME" HeaderText="计划开始时间" SortExpression="PLAN_STARTTIME" meta:resourcekey="BoundFieldResource8">
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="PLAN_ENDTIME" HeaderText="计划结束时间" SortExpression="PLAN_ENDTIME" meta:resourcekey="BoundFieldResource9">
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="计划用时" meta:resourcekey="BoundFieldResource10">
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px" />
                            </asp:BoundField>
                        </Columns>
