<%@ page language="C#" autoeventwireup="true" inherits="YW_GL_frmGL_SAFE_ACTIVITY, App_Web_yi4rgbqt" culture="auto" uiculture="auto" enableeventvalidation="false" meta:resourcekey="PageResource1" stylesheettheme="default" %>
...
<body>
   ...
   <div id="list_header" runat="server">
    ...
    <div id="list_data">
        <asp:GridView id="grvList" runat="server" meta:resourcekey="grvListResource1" Width="100%" PageSize="20" OnSelectedIndexChanged="grvRef_SelectedIndexChanged" DataKeyNames="TID" CssClass="font" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True">
            <Columns>
                ...
                <asp:BoundField DataField="DATEM" HeaderText="时间" DataFormatString="{0:yyyy-MM-dd HH:mm}" HtmlEncode="False" meta:resourcekey="BoundFieldResource3" >
                    <ItemStyle Width="80px" HorizontalAlign="Center"  />
                </asp:BoundField>
                <asp:BoundField DataField="LOCATION" HeaderText="地点" meta:resourcekey="BoundFieldResource1" >
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="ATTENDEE" HeaderText="参加人员" meta:resourcekey="BoundFieldResource5" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="EMCEE" HeaderText="主持人" meta:resourcekey="BoundFieldResource6">
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="RECORDER" HeaderText="记录人" meta:resourcekey="BoundFieldResource2">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="CHECKER" HeaderText="审核人" meta:resourcekey="BoundFieldResource4">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="CONTENT" HeaderText="活动内容" meta:resourcekey="BoundFieldResource10" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="QUESTION" HeaderText="发现问题" meta:resourcekey="BoundFieldResource8">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="CORRECT_ACTIVITIES" HeaderText="整改措施" meta:resourcekey="BoundFieldResource7">
                    <ItemStyle HorizontalAlign="Left"  />
                </asp:BoundField>
                <asp:BoundField DataField="PERSON_STATEMENT" HeaderText="个人发言" meta:resourcekey="BoundFieldResource9">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
            </Columns>
