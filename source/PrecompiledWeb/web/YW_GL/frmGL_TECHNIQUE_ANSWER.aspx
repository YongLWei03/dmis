<%@ page language="C#" autoeventwireup="true" inherits="YW_GL_frmGL_TECHNIQUE_ANSWER, App_Web_yi4rgbqt" culture="auto" uiculture="auto" enableeventvalidation="false" meta:resourcekey="PageResource2" stylesheettheme="default" %>
    ...
    <div id="list_data">
        <asp:GridView id="grvList" runat="server" meta:resourcekey="grvListResource1" Width="100%" PageSize="20" OnSelectedIndexChanged="grvRef_SelectedIndexChanged" DataKeyNames="TID" CssClass="font" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="">
            <Columns>
                ...
                <asp:BoundField DataField="EXAMINER" HeaderText="出题人" meta:resourcekey="BoundFieldResource1" >
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="ANSWERER" HeaderText="解答人" meta:resourcekey="BoundFieldResource6">
                    <ItemStyle Width="60px"  />
                </asp:BoundField>
                <asp:BoundField DataField="TOPIC" HeaderText="题目" meta:resourcekey="BoundFieldResource5" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="CONTENT" HeaderText="解答内容" meta:resourcekey="BoundFieldResource2" >
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="EVALUATION" HeaderText="评价" meta:resourcekey="BoundFieldResource4">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="APPRAISER" HeaderText="评价人" meta:resourcekey="BoundFieldResource7">
                    <ItemStyle Width="60px" />
                </asp:BoundField>
            </Columns>
